                                ...
                                <tbody>
                                    @foreach ($categories as $index => $item)
                                        <tr>
                                            ...
                                            <td class="{{ $item->categories_status ? 'text-success' : 'text-danger' }}">
                            ...
                            <tbody>
                                @foreach ($categories as $index => $item)
                                    <tr>
                                        ...
                                        <td class="{{ $item->categories_status == true ? 'text-success' : 'text-danger' }}">
                                            {{ $item->categories_status == true ? 'Hiển thị' : 'Ẩn' }}
                                        </td>
