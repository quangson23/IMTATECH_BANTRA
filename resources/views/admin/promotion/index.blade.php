                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                <thead>
                                    ...
                                    <th>#</th>
                                    <th>Tên chiến dịch khuyến mại</th>
                                    <th>Mô tả</th>
                                ...
                                <tbody>
                                    @foreach ($promotions as $index => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea class="form-control" rows="3" readonly>{{ strip_tags($item->promotions_description) }}</textarea>
                                            </td>
                                            ...
                                            <td>
                                                <span
                                                    class="{{ $item->promotions_condition ? 'badge bg-secondary text-white' : 'badge bg-secondary text-white' }}"
                                                    style="width: 100px; display: inline-block; text-align: center;">
                                                    {{ $item->promotions_condition ? 'Giảm theo %' : 'Giảm theo tiền' }}
                                                </span>
                                            </td>
