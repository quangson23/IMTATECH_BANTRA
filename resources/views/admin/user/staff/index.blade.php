...
@section('main-content')
    ...
    <div class="main-content">
        <section class="section">
            <div class="card">
                <h4 class="card-header">Danh sách nhân viên</h4>
                                ...
                                <tbody>
                                    @foreach ($users as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->role === 'Admin')
                                                    <span class="badge bg-danger w-50">{{ $item->role }}</span>
                                                @elseif ($item->role === 'Staff')
                                                    <span class="badge bg-warning w-50">{{ $item->role }}</span>
                                                @else
                                                    <span class="badge bg-secondary w-50">{{ $item->role }}</span>
                                                @endif
                                            </td>
