                            ...
                            <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                <div class="mb-4 p-0">
                                    <a class='auth-logo' href='index.html'>
                                        <img src="assets/auth/images/logo-dark.png" alt="logo-dark" class="mx-auto"
                                            height="28" />
                                    </a>
                                </div>
                                ...
                                <div class="pt-0">
                                    <form method="POST" action="{{ route('login') }}" class="my-4">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control @error('email') is-invalid @enderror" name="email" type="email"   id="email" required="required"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control"  name="password" type="password" required="required" id="password"
                    ...
                    <div class="account-page-bg p-md-5 p-4">
                        <div class="text-center">
                            ...
                            <div class="auth-image">
                                <img src="assets/auth/images/authentication.svg" class="mx-auto img-fluid" alt="images">
                            </div>
                        </div>
                    </div>
                </div> --}}
