                                ...
                                <div class="pt-0">
                                    <form method="POST" action="{{ route('register') }}" class="my-4">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" name="name" type="text" name="name"
                                                id="name" required="required" placeholder="Enter your Username"
                                                value="{{ old('name') }}">
                                            @error('name')
                    ...
                    <div class="account-page-bg p-md-5 p-4">
                        <div class="text-center">
                            ...
                            <div class="auth-image">
                                <img src="{{ asset('assets/auth/images/authentication.svg') }}" class="mx-auto img-fluid"
                                    alt="images">
                            </div>
                        </div>
                    </div>
