                            ...
                            <table class="table table-striped table-bordered tbl-shopping-cart">
                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-thumbnail"><a href="#"><img alt="product"
                                                    src="images/resource/products/1.jpg"></a></td>
                                        <td class="product-name"><a href="shop-product-details.html"> Set paper box</a>
                                            <ul class="variation">
                                            ...
                                            <form class="row g-3 coupon-form">
                                                <div class="col-auto">
                                                    <input type="text" name="coupon_code"
                                                        class="input-text form-control mr-1" id="coupon_code" value
                    ...
                    <div class="col-md-12 mt-30">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <a class="theme-btn btn-style-one" href="/checkout"><span class="btn-title">Proceed to
                                        Checkout</span> </a>
                            </div>
                        </div>
                    </div>
