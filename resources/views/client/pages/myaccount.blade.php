                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="dashboard" role="tabpanel">
                                ...
                                <div class="dashboard-header mb-4">
                                    ...
                                    <p>Sau đây là tổng quan về hoạt động và số liệu thống kê tài khoản của bạn.</p>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="card border-0 shadow-sm">
                                            <div class="card-body text-center">
                                                <h5 class="card-title">Giao thành công</h5>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="card border-0 shadow-sm">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text">{{ number_format($totalAmount, 0, ',', '.') }} VND</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="myaccount-content">
                                    ...
                                    <div class="mb-4">
                                        <div class="btn-group" role="group" aria-label="Order Status Filter">
                                            ...
                                            <button type="button" class="btn btn-secondary filter-btn"
                                                data-status="cho_xac_nhan">Chờ xác nhận</button>
                                            <button type="button" class="btn btn-secondary filter-btn"
                                                data-status="da_xac_nhan">Đã xác nhận</button>
                                            <button type="button" class="btn btn-secondary filter-btn"
                                                data-status="dang_chuan_bi">Đang chuẩn bị</button>
                                            <button type="button" class="btn btn-secondary filter-btn"
                                                data-status="dang_van_chuyen">Đang vận chuyển</button>
                                            <button type="button" class="btn btn-secondary filter-btn"
                                                data-status="da_giao_hang">Đã giao hàng</button>
                                            <button type="button" class="btn btn-secondary filter-btn"
                                                data-status="huy_don_hang">Hủy đơn hàng</button>
                                            <button type="button" class="btn btn-secondary filter-btn"
                                                data-status="chua_thanh_toan">Chưa thanh toán</button>
                                            <button type="button" class="btn btn-secondary filter-btn"
                                                data-status="da_thanh_toan">Đã thanh toán</button>
                            ...
                            <style>
                                ...
                                .profile-picture {
                                    ...
                                    /* Gray background for default */
                                    border-radius: 50%;
                                    /* Circle shape */
                                    overflow: hidden;
                                    /* Ensure content fits within circle */
                                    position: relative;
                                }
                                        ...
                                        <div class="  mb-4 text-center">
                                            ...
                                            <div class="profile-picture">
                                                <img id="profilePicPreview"
                                                    src="{{ Auth::user()->profile_picture ? asset('storage/' . Auth::user()->profile_picture) : 'path/to/default-gray-circle.png' }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterOrders(status) {
                // Get all rows in the orders table body
                const tableRows = document.querySelectorAll('#orders-table tbody tr');

                // Loop through each row in the table
                tableRows.forEach(row => {
                    // Extract the status text from the row
